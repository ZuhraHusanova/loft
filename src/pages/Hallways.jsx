...
export default function Hallways() {
  ...
  const changeFav = (el) => {
    el.saved = !el.saved
    axios.put(`https://652553ed67cfb1e59ce71adc.mockapi.io/hallways/${el.id}`, el, {
      headers: {
  ...
  useEffect(() => {
    axios.get("https://652553ed67cfb1e59ce71adc.mockapi.io/hallways", {
      headers: {
        "Content-Type": "application/json"
      }
